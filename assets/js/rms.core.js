...
class RiskManagementSystem {
    constructor() {
        ...
        this.actionPlans = this.loadData('actionPlans') || this.getDefaultActionPlans();
    ...
    getDefaultRisks() {
        return [
            { id: 1, processus: 'R&D', sousProcessus: 'Études cliniques', typeCorruption: 'trafic', tiers: ['Professionnels de santé'], description: 'Sélection orientée des investigateurs cliniques en échange d’avantages personnels.', probBrut: 3, impactBrut: 4, probNet: 2, impactNet: 3, probPost: 2, impactPost: 3, controls: [1, 2], actionPlans: [1], statut: 'validé', owner: 'Direction Médicale' },
            { id: 2, processus: 'R&D', sousProcessus: 'Affaires réglementaires', typeCorruption: 'active', tiers: ['Institutionnels'], description: 'Tentative d’influence d’un évaluateur via un intermédiaire pour accélérer une AMM.', probBrut: 2, impactBrut: 4, probNet: 2, impactNet: 3, probPost: 1, impactPost: 3, controls: [3], actionPlans: [2], statut: 'a-valider', owner: 'Affaires Réglementaires' },
            { id: 3, processus: 'Marketing', sousProcessus: 'Organisation d’événements', typeCorruption: 'cadeaux', tiers: ['Professionnels de santé'], description: 'Hospitalités excessives lors de congrès scientifiques pour influencer des prescriptions.', probBrut: 4, impactBrut: 3, probNet: 3, impactNet: 3, probPost: 2, impactPost: 2, controls: [4, 5], actionPlans: [3], statut: 'validé', owner: 'Compliance Marketing' },
            { id: 4, processus: 'Marketing', sousProcessus: 'Promotion médicale', typeCorruption: 'passive', tiers: ['Professionnels de santé'], description: 'Acceptation de demandes de sponsoring non conformes par des délégués médicaux.', probBrut: 3, impactBrut: 3, probNet: 2, impactNet: 3, probPost: 2, impactPost: 2, controls: [4], actionPlans: [], statut: 'validé', owner: 'Direction Commerciale' },
            { id: 5, processus: 'Achats', sousProcessus: 'Sourcing fournisseurs', typeCorruption: 'favoritisme', tiers: ['Collaborateurs'], description: 'Préqualification d’un fournisseur lié à un salarié sans déclaration de conflit.', probBrut: 3, impactBrut: 4, probNet: 2, impactNet: 3, probPost: 2, impactPost: 3, controls: [6, 7], actionPlans: [4], statut: 'validé', owner: 'Achats Groupe' },
            { id: 6, processus: 'Achats', sousProcessus: "Appels d'offres", typeCorruption: 'favoritisme', tiers: ['Acheteurs'], description: 'Critères d’appel d’offres construits pour favoriser un prestataire déjà identifié.', probBrut: 3, impactBrut: 3, probNet: 2, impactNet: 2, probPost: 2, impactPost: 2, controls: [6], actionPlans: [], statut: 'a-valider', owner: 'Achats Indirects' },
            { id: 7, processus: 'Finance', sousProcessus: 'Paiements', typeCorruption: 'active', tiers: ['Institutionnels'], description: 'Paiement de facilitation dissimulé dans une facture de conseil à l’international.', probBrut: 2, impactBrut: 4, probNet: 2, impactNet: 4, probPost: 1, impactPost: 3, controls: [8, 9], actionPlans: [5], statut: 'validé', owner: 'Trésorerie' },
            { id: 8, processus: 'Finance', sousProcessus: 'Comptabilité fournisseurs', typeCorruption: 'passive', tiers: ['Collaborateurs'], description: 'Validation d’une facture fictive contre avantage personnel.', probBrut: 3, impactBrut: 4, probNet: 2, impactNet: 3, probPost: 2, impactPost: 2, controls: [8], actionPlans: [], statut: 'validé', owner: 'Comptabilité' },
            { id: 9, processus: 'Ventes', sousProcessus: 'Soumissions d’offres', typeCorruption: 'trafic', tiers: ['Institutionnels'], description: 'Transmission d’informations confidentielles pour influencer une commission d’achat hospitalière.', probBrut: 3, impactBrut: 4, probNet: 2, impactNet: 3, probPost: 2, impactPost: 3, controls: [10], actionPlans: [], statut: 'a-valider', owner: 'Marchés Publics' },
            { id: 10, processus: 'Ventes', sousProcessus: 'Négociation/contrats', typeCorruption: 'active', tiers: ['Institutionnels'], description: 'Remise commerciale non justifiée accordée en contrepartie d’un engagement occulte.', probBrut: 2, impactBrut: 4, probNet: 2, impactNet: 3, probPost: 1, impactPost: 3, controls: [10], actionPlans: [], statut: 'validé', owner: 'Direction Accès Marché' },
            { id: 11, processus: 'Production', sousProcessus: 'Libération des lots', typeCorruption: 'passive', tiers: ['Collaborateurs'], description: 'Pression sur un pharmacien responsable pour libérer un lot non conforme.', probBrut: 2, impactBrut: 4, probNet: 2, impactNet: 4, probPost: 1, impactPost: 3, controls: [2], actionPlans: [], statut: 'validé', owner: 'Assurance Qualité' },
            { id: 12, processus: 'Production', sousProcessus: 'Maintenance des équipements', typeCorruption: 'cadeaux', tiers: ['Collaborateurs'], description: 'Acceptation d’avantages d’un mainteneur en échange d’une extension de contrat.', probBrut: 3, impactBrut: 3, probNet: 2, impactNet: 2, probPost: 2, impactPost: 2, controls: [7], actionPlans: [], statut: 'validé', owner: 'Maintenance' },
            { id: 13, processus: 'Juridique', sousProcessus: 'Conformité & éthique', typeCorruption: 'trafic', tiers: ['Politiques'], description: 'Intermédiation non documentée auprès d’autorités locales pour influencer une inspection.', probBrut: 2, impactBrut: 4, probNet: 2, impactNet: 4, probPost: 1, impactPost: 3, controls: [3, 9], actionPlans: [], statut: 'validé', owner: 'Ethique & Conformité' },
            { id: 14, processus: 'Juridique', sousProcessus: 'Rédaction/gestion des contrats', typeCorruption: 'favoritisme', tiers: ['Collaborateurs'], description: 'Clauses contractuelles avantageuses accordées à un partenaire lié à un décideur.', probBrut: 3, impactBrut: 3, probNet: 2, impactNet: 3, probPost: 2, impactPost: 2, controls: [7], actionPlans: [], statut: 'brouillon', owner: 'Juridique Corporate' },
            { id: 15, processus: 'RH', sousProcessus: 'Recrutement', typeCorruption: 'favoritisme', tiers: ['Collaborateurs'], description: 'Recrutement d’un proche d’un décideur public pour faciliter des futures décisions.', probBrut: 3, impactBrut: 3, probNet: 2, impactNet: 2, probPost: 2, impactPost: 2, controls: [1], actionPlans: [], statut: 'a-valider', owner: 'Ressources Humaines' },
            { id: 16, processus: 'RH', sousProcessus: 'Formation', typeCorruption: 'cadeaux', tiers: ['Professionnels de santé'], description: 'Invitations à des formations sans pertinence métier utilisées comme avantages indus.', probBrut: 3, impactBrut: 2, probNet: 2, impactNet: 2, probPost: 2, impactPost: 1, controls: [5], actionPlans: [], statut: 'validé', owner: 'Learning & Development' },
            { id: 17, processus: 'Finance', sousProcessus: 'Fiscalité', typeCorruption: 'trafic', tiers: ['Institutionnels'], description: 'Recours à un intermédiaire opaque pour négocier un redressement fiscal.', probBrut: 2, impactBrut: 4, probNet: 2, impactNet: 3, probPost: 1, impactPost: 3, controls: [9], actionPlans: [], statut: 'validé', owner: 'Fiscalité Groupe' },
            { id: 18, processus: 'Achats', sousProcessus: 'Négociation/contrats', typeCorruption: 'active', tiers: ['Acheteurs'], description: 'Attribution de remises contractuelles en contrepartie de rétrocommissions.', probBrut: 3, impactBrut: 4, probNet: 2, impactNet: 3, probPost: 2, impactPost: 3, controls: [6, 8], actionPlans: [], statut: 'validé', owner: 'Achats Directs' },
            { id: 19, processus: 'Ventes', sousProcessus: 'Distribution', typeCorruption: 'passive', tiers: ['Institutionnels'], description: 'Tolérance de pratiques de distribution non conformes via un distributeur tiers.', probBrut: 3, impactBrut: 3, probNet: 2, impactNet: 3, probPost: 2, impactPost: 2, controls: [10], actionPlans: [], statut: 'validé', owner: 'Supply Commerciale' },
            { id: 20, processus: 'R&D', sousProcessus: 'Pharmacovigilance', typeCorruption: 'passive', tiers: ['Professionnels de santé'], description: 'Sous-déclaration d’événements indésirables à la demande d’un partenaire.', probBrut: 2, impactBrut: 4, probNet: 2, impactNet: 4, probPost: 1, impactPost: 3, controls: [2, 3], actionPlans: [], statut: 'validé', owner: 'Pharmacovigilance' }
        ];
    }

    getDefaultControls() {
        return [
            { id: 1, name: 'Déclaration annuelle des conflits d’intérêts', type: 'a-priori', origin: 'interne', owner: 'Compliance Officer', frequency: 'Annuelle', mode: 'Manuel', effectiveness: 'Moyenne', status: 'Actif', description: 'Collecte et revue des déclarations pour les populations exposées.', risks: [1, 15] },
            { id: 2, name: 'Revue qualité indépendante des décisions critiques', type: 'a-posteriori', origin: 'interne', owner: 'Assurance Qualité', frequency: 'Mensuelle', mode: 'Manuel', effectiveness: 'Forte', status: 'Actif', description: 'Contrôle de second niveau sur les décisions de libération de lot et de sécurité patient.', risks: [1, 11, 20] },
            { id: 3, name: 'Due diligence renforcée des intermédiaires', type: 'a-priori', origin: 'interne', owner: 'Ethique & Conformité', frequency: 'À chaque engagement', mode: 'Hybride', effectiveness: 'Forte', status: 'Actif', description: 'Contrôle de réputation, bénéficiaires effectifs et clauses anti-corruption.', risks: [2, 13, 20] },
            { id: 4, name: 'Validation compliance des événements médicaux', type: 'a-priori', origin: 'interne', owner: 'Medical Affairs', frequency: 'À chaque événement', mode: 'Manuel', effectiveness: 'Moyenne', status: 'Actif', description: 'Approbation préalable des hospitalités et programmes scientifiques.', risks: [3, 4] },
            { id: 5, name: 'Contrôle des avantages et hospitalités', type: 'a-posteriori', origin: 'interne', owner: 'Audit Interne', frequency: 'Trimestrielle', mode: 'Automatisé', effectiveness: 'Moyenne', status: 'Actif', description: 'Analyses de seuils et de patterns atypiques dans les notes de frais.', risks: [3, 16] },
            { id: 6, name: 'Comité d’attribution achats', type: 'a-priori', origin: 'interne', owner: 'Directeur Achats', frequency: 'Hebdomadaire', mode: 'Manuel', effectiveness: 'Forte', status: 'Actif', description: 'Décision collégiale et traçabilité des critères d’évaluation.', risks: [5, 6, 18] },
            { id: 7, name: 'Séparation des tâches contractuelles', type: 'a-priori', origin: 'interne', owner: 'Contrôle Interne', frequency: 'Continue', mode: 'Automatisé', effectiveness: 'Moyenne', status: 'Actif', description: 'Blocage des cumuls de rôles entre demandeur, valideur et signataire.', risks: [5, 12, 14] },
            { id: 8, name: 'Revue de cohérence des factures sensibles', type: 'a-posteriori', origin: 'interne', owner: 'Comptabilité Fournisseurs', frequency: 'Mensuelle', mode: 'Hybride', effectiveness: 'Moyenne', status: 'Actif', description: 'Vérification ciblée des factures de conseil et prestations à risque.', risks: [7, 8, 18] },
            { id: 9, name: 'Contrôle renforcé des paiements internationaux', type: 'a-priori', origin: 'interne', owner: 'Trésorier Groupe', frequency: 'À chaque paiement', mode: 'Automatisé', effectiveness: 'Forte', status: 'Actif', description: 'Filtrage pays à risque, justification économique et revue des IBAN tiers.', risks: [7, 13, 17] },
            { id: 10, name: 'Revue légale des offres et remises', type: 'a-priori', origin: 'interne', owner: 'Direction Juridique', frequency: 'À chaque offre', mode: 'Manuel', effectiveness: 'Moyenne', status: 'Actif', description: 'Validation des propositions commerciales sensibles et clauses d’intégrité.', risks: [9, 10, 19] }
        ];
    }

    getDefaultActionPlans() {
        return [
            { id: 1, title: 'Renforcer la sélection des investigateurs cliniques', owner: 'Direction Médicale', dueDate: '2026-06-30', status: 'en-cours', description: 'Mettre en place une grille d’évaluation anti-corruption et une revue compliance systématique.', risks: [1] },
            { id: 2, title: 'Formaliser la gouvernance des interactions réglementaires', owner: 'Affaires Réglementaires', dueDate: '2026-05-15', status: 'a-demarrer', description: 'Créer un registre des interactions sensibles et former les équipes aux signaux faibles.', risks: [2] },
            { id: 3, title: 'Encadrer les hospitalités congrès', owner: 'Compliance Marketing', dueDate: '2026-04-30', status: 'en-cours', description: 'Mettre en œuvre des plafonds par typologie d’événement et contrôles préalables.', risks: [3] },
            { id: 4, title: 'Refondre le processus de due diligence fournisseurs', owner: 'Achats Groupe', dueDate: '2026-07-31', status: 'a-demarrer', description: 'Intégrer une notation risque tiers et un blocage des fournisseurs non évalués.', risks: [5] },
            { id: 5, title: 'Sécuriser les paiements de conseil à l’international', owner: 'Trésorerie', dueDate: '2026-03-31', status: 'en-cours', description: 'Ajouter une étape de validation conformité pour tout paiement à intermédiaire.', risks: [7] }
        ];
    }

    getDefaultInterviews() {
        return [
            { id: 1, interviewee: 'Directeur Médical', department: 'R&D', date: '2026-01-08', interviewer: 'Equipe Conformité', risksDiscussed: [1, 2], synthesis: 'Forte exposition sur la sélection des investigateurs.' },
            { id: 2, interviewee: 'Responsable Pharmacovigilance', department: 'R&D', date: '2026-01-09', interviewer: 'Equipe Conformité', risksDiscussed: [20], synthesis: 'Besoin de renforcer la traçabilité des échanges externes.' },
            { id: 3, interviewee: 'Manager Affaires Réglementaires', department: 'R&D', date: '2026-01-10', interviewer: 'Equipe Conformité', risksDiscussed: [2, 13], synthesis: 'Usage ponctuel d’intermédiaires à mieux encadrer.' },
            { id: 4, interviewee: 'Directeur Achats', department: 'Achats', date: '2026-01-13', interviewer: 'Equipe Conformité', risksDiscussed: [5, 6, 18], synthesis: 'Processus d’appel d’offres globalement mature, mais exceptions peu documentées.' },
            { id: 5, interviewee: 'Acheteur Senior Indirect', department: 'Achats', date: '2026-01-13', interviewer: 'Equipe Conformité', risksDiscussed: [6], synthesis: 'Clarifier les critères de sélection et la justification des dérogations.' },
            { id: 6, interviewee: 'Acheteur CAPEX', department: 'Achats', date: '2026-01-14', interviewer: 'Equipe Conformité', risksDiscussed: [5, 12], synthesis: 'Risque de dépendance fournisseurs historiques.' },
            { id: 7, interviewee: 'Directrice Marketing', department: 'Marketing', date: '2026-01-15', interviewer: 'Equipe Conformité', risksDiscussed: [3, 4], synthesis: 'Bonne culture compliance mais pression business élevée en congrès.' },
            { id: 8, interviewee: 'Responsable Événementiel Médical', department: 'Marketing', date: '2026-01-15', interviewer: 'Equipe Conformité', risksDiscussed: [3], synthesis: 'Nécessité d’un contrôle automatisé des plafonds hospitalité.' },
            { id: 9, interviewee: 'Responsable Communication Digitale', department: 'Marketing', date: '2026-01-16', interviewer: 'Equipe Conformité', risksDiscussed: [4], synthesis: 'Validation des contenus parfois tardive.' },
            { id: 10, interviewee: 'Directeur National des Ventes', department: 'Ventes', date: '2026-01-19', interviewer: 'Equipe Conformité', risksDiscussed: [9, 10], synthesis: 'Risque concentré sur marchés publics hospitaliers.' },
            { id: 11, interviewee: 'KAM Marchés Publics', department: 'Ventes', date: '2026-01-19', interviewer: 'Equipe Conformité', risksDiscussed: [9], synthesis: 'Interactions avec décideurs à formaliser davantage.' },
            { id: 12, interviewee: 'Responsable Contrats Ventes', department: 'Ventes', date: '2026-01-20', interviewer: 'Equipe Conformité', risksDiscussed: [10, 19], synthesis: 'Contrôles présents mais documentation hétérogène.' },
            { id: 13, interviewee: 'Directrice Finance', department: 'Finance', date: '2026-01-21', interviewer: 'Equipe Conformité', risksDiscussed: [7, 8, 17], synthesis: 'Exposition sur paiements internationaux et consultants.' },
            { id: 14, interviewee: 'Responsable Trésorerie', department: 'Finance', date: '2026-01-21', interviewer: 'Equipe Conformité', risksDiscussed: [7, 17], synthesis: 'Souhaite des règles d’escalade plus précises.' },
            { id: 15, interviewee: 'Chef Comptable Fournisseurs', department: 'Finance', date: '2026-01-22', interviewer: 'Equipe Conformité', risksDiscussed: [8], synthesis: 'Détections manuelles trop chronophages.' },
            { id: 16, interviewee: 'Responsable Fiscalité Groupe', department: 'Finance', date: '2026-01-22', interviewer: 'Equipe Conformité', risksDiscussed: [17], synthesis: 'Encadrer les mandats confiés aux cabinets externes.' },
            { id: 17, interviewee: 'Directeur Industriel', department: 'Production', date: '2026-01-23', interviewer: 'Equipe Conformité', risksDiscussed: [11, 12], synthesis: 'Niveau de formalisation correct, points de vigilance sur maintenance.' },
            { id: 18, interviewee: 'Pharmacien Responsable', department: 'Production', date: '2026-01-23', interviewer: 'Equipe Conformité', risksDiscussed: [11], synthesis: 'Pression sur délais de libération ponctuelle.' },
            { id: 19, interviewee: 'Responsable Maintenance', department: 'Production', date: '2026-01-26', interviewer: 'Equipe Conformité', risksDiscussed: [12], synthesis: 'Risque cadeaux fournisseurs connu mais suivi faible.' },
            { id: 20, interviewee: 'Responsable Contrôle Qualité', department: 'Production', date: '2026-01-26', interviewer: 'Equipe Conformité', risksDiscussed: [11], synthesis: 'Besoin d’un reporting plus fréquent vers la conformité.' },
            { id: 21, interviewee: 'DRH Groupe', department: 'RH', date: '2026-01-27', interviewer: 'Equipe Conformité', risksDiscussed: [15, 16], synthesis: 'Renforcer les messages sur conflits d’intérêts au recrutement.' },
            { id: 22, interviewee: 'Responsable Talent Acquisition', department: 'RH', date: '2026-01-27', interviewer: 'Equipe Conformité', risksDiscussed: [15], synthesis: 'Formaliser les vérifications de liens d’intérêts.' },
            { id: 23, interviewee: 'Responsable Formation', department: 'RH', date: '2026-01-28', interviewer: 'Equipe Conformité', risksDiscussed: [16], synthesis: 'Contenus compliance pertinents mais diffusion incomplète.' },
            { id: 24, interviewee: 'Directeur Juridique', department: 'Juridique', date: '2026-01-29', interviewer: 'Equipe Conformité', risksDiscussed: [13, 14], synthesis: 'Encadrement contractuel solide, vigilance sur due diligence des tiers.' },
            { id: 25, interviewee: 'Juriste Contrats', department: 'Juridique', date: '2026-01-29', interviewer: 'Equipe Conformité', risksDiscussed: [14], synthesis: 'Des exceptions contractuelles doivent être mieux justifiées.' },
            { id: 26, interviewee: 'Responsable Conformité', department: 'Juridique', date: '2026-01-30', interviewer: 'Equipe Conformité', risksDiscussed: [13], synthesis: 'Cartographie actuelle à consolider par données quantitatives.' },
            { id: 27, interviewee: 'Internal Audit Manager', department: 'Audit', date: '2026-02-02', interviewer: 'Equipe Conformité', risksDiscussed: [3, 8, 18], synthesis: 'Axes prioritaires: dépenses promotionnelles et achats.' },
            { id: 28, interviewee: 'RSSI', department: 'IT', date: '2026-02-02', interviewer: 'Equipe Conformité', risksDiscussed: [9, 19], synthesis: 'Traçabilité des validations électroniques à améliorer.' },
            { id: 29, interviewee: 'Directeur Filiale Export', department: 'International', date: '2026-02-03', interviewer: 'Equipe Conformité', risksDiscussed: [7, 17], synthesis: 'Risque pays élevé sur certains marchés émergents.' },
            { id: 30, interviewee: 'Compliance Business Partner', department: 'Conformité', date: '2026-02-03', interviewer: 'Direction Conformité', risksDiscussed: [1, 3, 5, 7], synthesis: 'Plan de remédiation transversal priorisé sur 5 risques majeurs.' }
        ];
    }
